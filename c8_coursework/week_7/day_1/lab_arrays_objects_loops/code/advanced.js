 ...
 */
unitedKingdom[1].touristAttractions = ["British Museum", "Hyde Park"];
...
} else if (unitedKingdom[0].population >  unitedKingdom[2].population) {
...
} else if (unitedKingdom[0].population >  unitedKingdom[3].population) {
